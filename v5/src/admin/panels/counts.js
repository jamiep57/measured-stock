...
export async function mountCountsPanel(route) {
  ...
  function bindSessionBar() {
    ...
    $('cntDeleteSession')?.addEventListener('click', async () => {
  ...
  function openPrintCountSheetsDialog() {
    ...
    $('cntPrintCancel')?.addEventListener('click', async () => closeSheet());
    $('cntPrintGo')?.addEventListener('click', async () => {
