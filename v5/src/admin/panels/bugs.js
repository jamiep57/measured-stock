 ...
 */
export async function openBugReportForm(opts = {}) {
  ...
  $('bugSave').onclick = async () => saveBug();
  $('bugShotCapture').onclick = async () => captureShot();
  $('bugShotClear').onclick = async () => clearShot();
  if (b) $('bugDelete').onclick = async () => deleteBug();
  $('bugTitle')?.focus();
}async function captureShot() {
    const btn = $('bugShotCapture');
    const err = $('bugErr');
