...
/** Readable (non-HttpOnly) display name for collaborative presence. */
export const DISPLAY_NAME_COOKIE = 'ms_display_name';
export const DISPLAY_NAME_MAX_LEN = 40;

/**
 * Normalize a typed unlock name for cookies / presence.
 * @param {unknown} raw
 * @returns {string|null} trimmed name, or null if missing/invalid
 */
